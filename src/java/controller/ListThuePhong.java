 ...
 * @author Admin
 */
public class ListThuePhong extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("listTP", list1);
        request.getRequestDispatcher("ListRoomActive.jsp").forward(request, response);
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ListThuePhong.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
