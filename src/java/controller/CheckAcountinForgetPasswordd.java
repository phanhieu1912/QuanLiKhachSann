 ...
 * @author Admin
 */
public class CheckAcountinForgetPasswordd extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       DAO dao = new DAO();
        ...
        List<Account> listAccountuser = dao.checkAccountExistByList(usernamee);
        if (listAccountuser.isEmpty()) {       
            request.setAttribute("mess", "Invalid Account and Try Again !!!");
