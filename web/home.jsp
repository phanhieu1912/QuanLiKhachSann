...
<html lang="en">
    ...
    <body>
        <%
            List<Room> listR = (List<Room>)request.getAttribute("listR");
            if(listR==null){
                ...
                <div class="container-fluid">
                    ...
                    <div class="menu_main">
                        <ul>
                            ...
                            <li><a href="manager.jsp">Contact us</a></li>
...
<!--                        <div class="col-md-4">
        ...
        <div class="services_section layout_padding">
            <div class="container">
                ...
                <p class="services_text text-center">A wonderful serenity has taken possession of my entire soul, 
                    like these sweet mornings of spring which I enjoy with my whole heart. I am alone, and feel the
                    charm of existence in this spot, which was created for the bliss of soul.</p>
                <div class="services_section_2">
                    <div class="row">
                        ...
                        <c:forEach items="${listR}" var ="o">
                            <div class="col-md-4">
                                <div class="room">
                                    <img src="${o.imgPhong}" class="room-img">
                                    <div class="price">
                                        <p>From ${o.giaPhong}$/Night</p>
                                    </div>
                                    <div class="room-item">
                                        <h2 class="room-name">${o.tenPhong}</h2>
                                        <ul class="room-info">
                                            <li>
                                        ...
                                        <a class="room-link" href="">READ MORE
