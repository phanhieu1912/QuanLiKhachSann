...
.active{
    display:block;
      ...
      <div class="container-fluid">
        ...
        <form action="UpdateNhanVienPhucVu" method="post" class="">
          <div class="container-fluid">
            <div class="container">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                  <div class="card h-100">
                    <div class="card-body">
                      <div class="row gutters">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                          <h6 class="mb-2 text-primary">Change Information Phuc Vu</h6>
                        </div>
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                          <div class="form-group">
                            <label for="fullName">ID Phuc Vu</label>
                            <input name="pid" type="text" class="form-control" id="user" placeholder="Enter ID Le Tan" value="${detail1.iDPhucVu}">
                          </div>
                        </div>
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                          <div class="form-group">
                            <label for="fullName">Ten Phuc Vu</label>
                            <input name="namee" type="text" class="form-control" id="user" value="${detail1.tenPhucVu}"
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                          <div class="form-group">
                            ...
                            <input name="gioitinh" type="text" class="form-control" id="gioitinh"
                              placeholder="Enter Gioi Tinh" value="${detail1.gioiTinh}">
                          </div>
                        </div>
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                          <div class="form-group">
                            ...
                            <input name="image" type="text" class="form-control" id="user"
                              placeholder="Enter Image Nhan Vien Le Tan" value="${detail1.imgNVPV}" >
                          </div>
                        </div>
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                          <div class="form-group">
                            <label for="eMail">Ngay Sinh</label>
                            <input name="ngaysinh" type="text" class="form-control" id="password" placeholder="Enter Ngay Sinh" value="${detail1.ngaySinh}">
                          </div>
                        </div>
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                          <div class="form-group">
                            <label for="eMail">Email</label>
                            <input name="email" type="email" class="form-control" id="password" placeholder="Email" value="${detail1.email}">
                          </div>
                        </div>
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                          <div class="form-group">
                            <label for="fullName">Dia Chi</label>
                            <input name="diachi" type="text" class="form-control" id="user" placeholder="Enter Dia Chi" value="${detail1.diaChi}">
                          </div>
                        </div>
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                          <div class="form-group">
                            ...
                            <input name="phone" type="text" class="form-control" id="user"
                              placeholder="Enter So Dien Thoai" value="${detail1.soDienthoai}">
                          </div>
                        </div>
                          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                          <div class="form-group">
                            <label for="fullName">ID Phong</label>
                            <input name="idPhong" type="text" class="form-control" id="user"
                              placeholder="Enter Quoc Tich" value="${detail1.iDPhong}">
                          </div>
                        </div>
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                          <div class="form-group">
                            ...
                            <input name="quoctich" type="text" class="form-control" id="user"
                              placeholder="Enter Quoc Tich" value="${detail1.quocTich}">
                          </div>
                        </div>
