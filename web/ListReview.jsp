...
<html lang="en">
    ...
    <body>
        <%
            List<Review> listRe = (List<Review>) request.getAttribute("listRe");
            if (listRe == null) {
                response.sendRedirect("ListReviewKHinAdmin");
            }
        %>
        <!--  Body Wrapper -->
            ...
            <aside class="left-sidebar">
                ...
                <div class="body-wrapper">
                    ...
                    <div class="container-fluid">
                        <h1 class="caption">REVIEW YOUR USER</h1>
                        <table>
                        ...
                        <c:forEach items="${listRe}" var ="s">
                            <tbody>

                                <tr>
                                    <td>${s.iDChiTietThuePhong}</td>
