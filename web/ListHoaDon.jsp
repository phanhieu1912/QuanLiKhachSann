...
<html lang="en">
    ...
    <body>
        <%
            List<ChiTietThuePhong> listTT = (List<ChiTietThuePhong>) request.getAttribute("listTT");
            if (listTT == null) {
                        ...
                        <c:forEach items="${listTT}" var ="s">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>${s.iDKhachHang}</td>
                                    <td>
           <a href=CheckInformationHoaDon?pid=${s.iDHoaDon} class="btn btn-danger openConfirm" data-toggle="modal">Check</a>
                                    </td>
