...
<html lang="en">
    ...
    <body>
        <%
            List<Phong> listP = (List<Phong>) request.getAttribute("listP");
            if (listP == null) {
                                ...
                                <div class="room-item col-md-4">
                                    ...
                                    <div class="room">
                                        ...
                                        <div class="room-item">
                                            ...
                                            <div class="thao-tac">
                                                <a href="ListPhongByID?pid=${o.iDPhong}" class="btn btn-primary">Edit</a>
                                                <a href="DeletePhong?pid=${o.iDPhong}" class="btn btn-danger">Delete</a>
                                            </div>
