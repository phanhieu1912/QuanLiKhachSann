...
<html lang="en">
    ...
    <body>
        <%
            ...
            if (listK == null) {
                response.sendRedirect("RoomPaid");
            }
        %>
        <!--  Body Wrapper -->
            ...
            <aside class="left-sidebar">
                ...
                <div class="body-wrapper">
                    ...
                    <div class="container-fluid">
                        <h1 class="caption">My History</h1>
                        <table>
                        ...
                        <c:forEach items="${listK}" var ="s">
                            <c:if test="${s.tinhTrangChiTietThuePhong == 2}">
                            <tbody>
                                <tr>
                                    <td>${s.iDPhong}</td>
                                    ...
                                    <td><a href="Review?pid=${s.iDChiTietThuePhong}&zid=${s.idNgayDaDatPhong}&checkIn=${s.ngayNhanPhong}&checkOut=${s.ngayTraPhong}"
                                               class="btn btn-primary" data-toggle="modal"><i class="fa-solid fa-pen-nib"></i></a></td>
                                </tr>
                            </tbody>
                            </c:if>
                        </c:forEach>
