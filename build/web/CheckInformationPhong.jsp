...
<html lang="en">
    ...
    <body>
        <%
            List<LoaiPhong> listLP = (List<LoaiPhong>) request.getAttribute("listLP");
            if (listLP == null) {
                response.sendRedirect("ListPhongByID");
            }
        %>
        <!--  Body Wrapper -->
                        ...
                        <c:forEach  items="${listP}" var ="s">
                            <div class="room-date">
                                <div class="input-group mb-3">
                                    ...
                                    <input name="iDPhong" type="text" value="${s.iDPhong}" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1">
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="basic-addon1">Price</span>
                                    </div>
                                    <input name="giaPhong" type="text" value="${s.giaPhong}" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1">
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
